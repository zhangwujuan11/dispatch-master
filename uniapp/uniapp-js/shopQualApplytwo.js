...
var vm = new Vue({
      ...
      if (this.shopInfo.taskFlag == 0) {
        ...
        Service.shopAuditPay('POST', JSON.stringify(params), (function callback(data) {
          if (data.code == 200) {
				...
				webview.loadURL(data.data.mwebUrl, {'Referer': 'https://www.edows.cn'});
          } else {
  ...
  mounted: function () {
	...
	picker.on('picker.valuechange', function (selectedVal, selectedIndex) {
		  ...
		  _self.shopInfo.saleAreaId = city[one].children[two].children[three].value
		  ...
		  //   _self.shopInfo.zone = items[2].text;
		    ...
		    let params = {
		      zonesId: city[one].children[two].children[three].value,
	...
	// document.write('<script ref="test66" id="test66" type="text/javascript" src="js/mui.min.js?v=2.5"></script> <script type="text/javascript" src="js/mui.picker.min.js"></script>')
  }
})
