...
var data = {
    ...
    timeStamp: '',
    memberInfo: {},
    surveyOrderSn: "2019051510100008"
...
var vm = new Vue({
    ...
    methods: {
        ...
        getData() {
            var _self = this;
            var params = { orderSn: tempJson.orderSn ? tempJson.orderSn : "" };
            Service.getRightCardOrderDetail('GET', params, (function callback(data) {
                ...
                if (data.code == 200) {
                    ...
                    _self.rightCardDetail = data.data.rightCardDetail;
                    _self.safeguards = _self.rightCardDetail.safeguards;
                    _self.userInfo = _self.info.userInfo
                }
            }))
        },
        //得到权益审核信息
        ...
        //收款码
        codePay() {
            window.location.href = "cardPay.html?orderSn=" + (tempJson.orderSn ? tempJson.orderSn : "");
        },
        //判断信息
        chackInfo() {
        ...
        add(type) {
            ...
            Service.auditRightCardOrder('POST', JSON.stringify(params), (function callback(data) {
                //console.log("数据：", data)
                if (data.code == 200) {
                    _self.getData();
                    //alert(type)
