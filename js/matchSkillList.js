...
var vm = new Vue({
    ...
    methods: {
        //查看详情
        viewDetail(e) {
            window.location.href = "matchSkillDetail.html?realId=" + e.id;
        },
        
        //新建店员信息
        add() {
           
            window.location.href = "matchSkill.html";
        },
        ...
        getListDataFromNet: function(pageNum, pageSize, successCallback, errorCallback) {
            ...
            Service.getCompetitionList('POST', JSON.stringify(params), (function callback(data) {
                console.log("=====数据：", data)
                if (data.code == 200) {
