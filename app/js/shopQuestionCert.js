...
var vm = new Vue({
    ...
    methods: {
        ...
        getSupervisionInfo() {
            var _self = this;
            var params = {};
            Service.getSupervisionInfo('GET', params, (function callback(data) {
        ...
        add() {
            ...
            Service.submitSupervisionApply('POST', JSON.stringify(params), (function callback(data) {
                if (data.code == 200) {
                    fn.showTip("提交成功");
                    _self.getSupervisionInfo();
                    //fn.showTip("提交成功","surveyList.html");
                }
            }))
