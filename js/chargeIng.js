...
var vm = new Vue({
    ...
    methods: {
        ...
        //确认结算
        toChargeListEnd(){
            window.location.href="chargeEnd.html";
        },
        ...
        getListDataFromNet: function(pageNum, pageSize, successCallback, errorCallback) {
            ...
            Service.getSetdqrList('POST', JSON.stringify(params), (function callback(data) {
                console.log("=====数据：", data)
                if (data.code == 200) {
